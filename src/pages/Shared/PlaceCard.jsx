...
const PlaceCard = ({ data, onClick }) => {
  return (
    <div>
      <div onClick={()=>onClick(data?.id)} className="max-w-[350px] w-full max-h-[200px] h-full rounded-lg border-[1px] relative flex justify-center items-center transform hover:scale-105 transition-transform duration-300 ease-in-out group hover:cursor-pointer drop-shadow-lg">
