  ...
  return (
    <div className="pt-[100px] container px-5">
      ...
      <div className="grid  grid-cols-12 gap-2">
        <div className="border shadow-md col-span-8  p-5 rounded">
        ...
        <div className="border shadow-md col-span-4  rounded p-5 h-[250px] sticky top-[75px]">
            <h1 className="text-xl  font-semibold text-[#333333] uppercase font-chakra drop-shadow-lg mb-5 ">Summary</h1>

            <h2 className="font-semibold">Place: Saint Martin Island</h2>

            <h2 className="font-semibold">Duration: 3 days 4 night</h2>

            <h1 className="  font-semibold text-green-700 drop-shadow-lg">Price : ৳ 5999 TK </h1>
