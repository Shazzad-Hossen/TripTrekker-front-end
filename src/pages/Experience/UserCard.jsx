...
const UserCard = () => {
    ...
    return (
        <div className='rounded p-3 w-full flex gap-4'>
            ...
            <input type="text" className=" border  bg-[white] w-full rounded-md p-5 placeholder:text-[#aaaaaa] outline-none focus:placeholder:opacity-0 mb-3"placeholder='Your text here' />
